  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8">Executive Summary Resume</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-6 overflow-y-auto max-h-[calc(100vh-200px)]">
            ...
            <div className="mb-8 p-4 bg-amber-50 rounded-lg border-2 border-amber-700">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <label className="cursor-pointer bg-amber-700 text-white px-4 py-2 rounded hover:bg-amber-800 transition block text-center font-semibold">
          ...
          {/* RIGHT: PREVIEW */}
          <div className="bg-white rounded-lg shadow overflow-hidden max-h-[calc(100vh-200px)] overflow-y-auto sticky top-8 border-t-8 border-amber-700">
